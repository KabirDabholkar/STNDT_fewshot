...
def main():
    ...
    with h5py.File(target_path, 'r') as h5file:
        ...
        # {f'{variant}': {key: h5file[f'{variant}'][key][()].astype(np.bool_) if key == 'train_decode_mask' or key == 'eval_decode_mask'
    ...
    print('target_dict',target_dict['mc_maze'].keys())
    print('few_shot_metadata',few_shot_metadata)
